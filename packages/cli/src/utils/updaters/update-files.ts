...
export function resolveNestedFilePath(
  ...
  // Example: "registry/hui/ui/button/Button.vue" -> "button/Button.vue"
  const lastCommonRootSegment = normalizedCommonRoot.split('/').pop()

  // normalizedFilePath: registry/hui/ui/button/Button.vue
  // normalizedCommonRoot: registry/hui/ui/button
