...
describe('createProject', () => {
  ...
  afterEach(() => {
    ...
    delete process.env.HUI_TEMPLATE_DIR
  })
  ...
  it('should download template via giget for nuxt', async () => {
    ...
    expect(downloadTemplate).toHaveBeenCalledWith(
      'github:unovue/hui-vue/templates/nuxt#dev',
      { dir: '/test/my-app' },
    )
  })
  ...
  it('should download template via giget for vite', async () => {
    ...
    expect(downloadTemplate).toHaveBeenCalledWith(
      'github:unovue/hui-vue/templates/vite#dev',
  ...
  it('should download template via giget for astro', async () => {
    ...
    expect(downloadTemplate).toHaveBeenCalledWith(
      'github:unovue/hui-vue/templates/astro#dev',
  ...
  it('should download template via giget for laravel', async () => {
    ...
    expect(downloadTemplate).toHaveBeenCalledWith(
      'github:unovue/hui-vue/templates/laravel#dev',
      { dir: '/test/my-laravel-app' },
    )
  })

  it('should use local template dir when HUI_TEMPLATE_DIR is set', async () => {
    process.env.HUI_TEMPLATE_DIR = '/local/templates'
