---
title: Tailwind v4
description: How to use hui-vue with Tailwind v4.
---
...
Take a look and test the components. If you find any bugs, please let me know on [GitHub](https://github.com/unovue/hui-vue).
...
One of the major advantages of using `hui-vue` is that the code you end up with is exactly what you'd write yourself. There are no hidden abstractions.
