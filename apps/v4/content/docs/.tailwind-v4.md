---
title: Tailwind v4
description: How to use hui-kit with Tailwind v4.
---
...
<div class="flex gap-2 items-center mt-6 not-docs">
  ...
  <Button asChild size="sm" variant="outline" class="rounded-lg">
    <a href="https://v4.localhost:3000" target="_blank" rel="noopener noreferrer">
      See Demo
    </a>
  </Button>
</div>
...
I put together a demo with all the updated components here: https://v4.localhost:3000

Take a look and test the components. If you find any bugs, please let me know on [GitHub](https://github.com/Clientik/hui-vue).
...
One of the major advantages of using `hui-kit` is that the code you end up with is exactly what you'd write yourself. There are no hidden abstractions.
