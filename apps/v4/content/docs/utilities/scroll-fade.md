...
If your project was set up with `npx hui-vue@latest init`, you already have `scroll-fade`. It ships with the `hui-vue` package, which the CLI imports in your global CSS file.
