...
::vue-school-link{lesson="theming-with-hui-vue" placement="top"}
Watch a Vue School video about theming with hui-vue.
::

<Callout>

Want to build your theme visually? Use [hui-vue/create](/create) to preview colors, radius, fonts, and icons, then generate a preset for your project.
...
```bash
npx hui-vue@latest init --no-css-variables
```
