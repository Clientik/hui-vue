...
::vue-school-link{lesson="install-hui-vue" placement="top"}
Watch a Vue School video on how to install hui-vue.
::
...
Run the `hui-vue` init command to setup your project:
