...
```bash
npx hui-kit@latest add aspect-ratio
```
...
::::tabs-content{value="manual"}
  :::steps
    ...
    ::step
    Copy and paste the [GitHub source code](https://github.com/Clientik/hui-vue/tree/dev/apps/v4/registry/hui/ui/aspect-ratio) into your project.
    ::
