...
**Legacy**: Component will be moved to an extended repo with Tailwind v4 support.
...
The custom component would receive `title` and `data` props, check out [ChartTooltip.vue component](https://github.com/Clientik/hui-vue/tree/dev/apps/www/registry/default/ui/chart/ChartTooltip.vue) for example.
