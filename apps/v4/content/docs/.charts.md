...
**Legacy**: Component will be moved to [extended repo](https://github.com/unovue/hui-vue/issues/1077) with Tailwind v4 support.
...
The custom component would receive `title` and `data` props, check out [ChartTooltip.vue component](https://github.com/unovue/hui-vue/tree/dev/apps/www/registry/default/ui/chart/ChartTooltip.vue) for example.
