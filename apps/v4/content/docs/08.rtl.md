---
title: RTL
description: Right-to-left support for hui-vue components.
---

hui-vue components have first-class support for right-to-left (RTL) layouts. Text alignment, positioning, and directional styles automatically adapt for languages like Arabic, Hebrew, and Persian.
...
```bash
npx hui-vue@latest migrate rtl [path]
```
