    ...
    <Example title="With Form">
      <Sheet>
        ...
        <SheetContent>
          ...
          <div class="style-vega:px-4 style-maia:px-6 style-mira:px-6 style-lyra:px-4 style-neva:px-4">
            <FieldGroup>
              <Field>
      ...
      <div class="flex flex-wrap gap-2">
        <Sheet v-for="side in SHEET_SIDES" :key="side">
          ...
          >
            ...
            <div class="no-scrollbar style-vega:px-4 style-maia:px-6 style-mira:px-6 style-lyra:px-4 style-neva:px-4 overflow-y-auto">
              <p
                v-for="index in 10"
                :key="index"
