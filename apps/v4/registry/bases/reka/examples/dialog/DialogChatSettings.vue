      ...
      <DialogContent class="min-w-md">
        ...
        <div class="flex flex-col gap-4">
          ...
          <Tabs v-model="tab">
            ...
            <div class="style-neva:p-4 style-vega:p-6 style-maia:p-6 style-mira:p-4 style-lyra:p-4 style-vega:min-h-[550px] style-maia:min-h-[550px] style-mira:min-h-[450px] style-lyra:min-h-[450px] style-neva:min-h-[460px] style-neva:rounded-lg style-vega:rounded-lg style-maia:rounded-xl style-mira:rounded-md style-lyra:rounded-none border [&_[data-slot=select-trigger]]:min-w-[125px]">
