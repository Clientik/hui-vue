  ...
  <Example title="Scrollable Content" class="items-center justify-center">
    <Dialog>
      ...
      <DialogContent>
        ...
        <div class="style-neva:-mx-4 style-neva:px-4 no-scrollbar style-vega:px-6 style-mira:px-4 style-maia:px-6 style-vega:-mx-6 style-maia:-mx-6 style-mira:-mx-4 style-lyra:-mx-4 style-lyra:px-4 max-h-[70vh] overflow-y-auto">
          <p
            v-for="index in 10"
            :key="index"
