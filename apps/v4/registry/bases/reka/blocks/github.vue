...
const contributors = [
  { name: "hui", image: "/avatars/01.png", commits: 1234 },
          ...
          <Tabs default-value="codespaces">
            ...
            <TabsContent value="codespaces">
              ...
              <div class="text-muted-foreground p-1.5 text-xs">
                ...
                <span class="font-medium">hui</span>.
              </div>
            </TabsContent>
                  ...
                  <TabsContent value="https">
                    <Field class="gap-2">
                      ...
                      <InputGroup>
                        ...
                        <InputGroupInput
                          id="https-url"
                          model-value="https://github.com/hui-ui/ui.git"
                          readonly
                        />
                      </InputGroup>
                      <FieldDescription>
                  ...
                  <TabsContent value="ssh">
                    <Field class="gap-2">
                      ...
                      <InputGroup>
                        ...
                        <InputGroupInput
                          id="ssh-url"
                          model-value="git@github.com:hui-ui/ui.git"
                          readonly
                        />
                      </InputGroup>
                      <FieldDescription>
                  ...
                  <TabsContent value="cli">
                    <Field class="gap-2">
                      ...
                      <InputGroup>
                        ...
                        <InputGroupInput
                          id="cli-command"
                          model-value="gh repo clone hui-ui/ui"
                          readonly
                        />
                      </InputGroup>
                      <FieldDescription>
