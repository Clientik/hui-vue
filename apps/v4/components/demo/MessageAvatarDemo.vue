...
import { Avatar, AvatarFallback, AvatarImage } from '@/styles/reka-neva/ui/avatar'
import { Bubble, BubbleContent, BubbleGroup } from '@/styles/reka-neva/ui/bubble'
import { Message, MessageAvatar, MessageContent } from '@/styles/reka-neva/ui/message'
</script>
