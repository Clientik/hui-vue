...
This document summarizes all the demo components that have been created to match the hui-ui React examples, adapted for Vue 3.
...
import { Alert, AlertDescription, AlertTitle } from '@/registry/hui/ui/alert'
// etc.
```
...
### Styling & Classes
- Consistent with hui-ui design patterns
...
The created components provide a solid foundation that matches the React hui-ui examples. They can be used for:
