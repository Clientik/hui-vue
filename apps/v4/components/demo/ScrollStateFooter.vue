...
import { CardFooter } from '@/styles/reka-neva/ui/card'
import { useMessageScrollerScrollable } from '@/styles/reka-neva/ui/message-scroller'

const scrollable = useMessageScrollerScrollable()

const status = computed(() => getScrollStatus(scrollable.value))
